...
# s390x linux
oc login --token=wSIUyh49fEGfWHfaJULfobfglihkrpMMGhBPs1S6RSc --server=https://api.ocpx86.cp.fyre.ibm.com:6443 --insecure-skip-tls-verify
# oc whoami
# oc project
...
./mvnw -pl \!configmap/file-system,\!config-secret/file-system,\!deployment-strategies/quarkus clean verify -Dquarkus.s2i.base-jvm-image=docker.io/cosmoxiix/adopt11openj9px -Dversion.quarkus=1.7.2.Final -Dts.use-ephemeral-namespaces
test_exit_code=$?
