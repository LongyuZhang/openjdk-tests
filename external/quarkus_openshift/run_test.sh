...
./mvnw -pl \!configmap,\!microprofile,\!external-applications/todo-demo-app,\!deployment-strategies/quarkus clean verify -Dquarkus.s2i.base-jvm-image=docker.io/cosmoxiix/adopt11hotspot -Dversion.quarkus=1.6.0.Final -Dts.use-ephemeral-namespaces
test_exit_code=$?
