...
./mvnw -pl \!microprofile,\!external-applications/todo-demo-app,\!deployment-strategies/quarkus clean verify -Dquarkus.s2i.base-jvm-image=docker.io/cosmoxiix/myjava11 -Dversion.quarkus=1.6.0.Final -Dts.use-ephemeral-namespaces
test_exit_code=$?
